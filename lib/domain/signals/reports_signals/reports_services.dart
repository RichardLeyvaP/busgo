...
Future<void> getReports1( id, type,date,endDate)  async {
  ...
  try {
    final result = await reportsRepository.getReports1Repository( id, type,date,endDate); // Llamada al backend
...
Future<void> getReports2( id, type,date,endDate)  async {
  ...
  try {
    final result = await reportsRepository.getReports2Repository( id, type,date,endDate); // Llamada al backend
